...
en:
  ...
  description: "Online free audio trimmer, no upload and registration required."
  play: "Play"
  pause: "Pause"
...
zh:
  ...
  zoom: "缩放"
es:
  toolName: "Recortador de Audio"
  description: "Recortador de audio gratuito en línea, sin necesidad de cargar ni registrarse."
  play: "Reproducir"
  pause: "Pausar"
  playRegion: "Reproducir Región"
  pauseRegion: "Pausar Región"
  trim: "Recortar"
  download: "Descargar"
  clear: "Limpiar"
  ...
  zoom: "Zoom"
pt:
  toolName: "Cortador de Áudio"
  description: "Cortador de áudio online gratuito, sem necessidade de upload ou registro."
  play: "Reproduzir"
  pause: "Pausar"
  playRegion: "Reproduzir Região"
  pauseRegion: "Pausar Região"
  trim: "Cortar"
  download: "Baixar"
  clear: "Limpar"
  ...
  zoom: "Zoom"
id:
  toolName: "Pemotong Audio"
  description: "Pemotong audio online gratis, tanpa perlu unggah dan registrasi."
  play: "Putar"
  pause: "Jeda"
  playRegion: "Putar Area"
  pauseRegion: "Jeda Area"
  trim: "Potong"
  download: "Unduh"
  clear: "Bersihkan"
  ...
  zoom: "Zoom"
fr:
  toolName: "Découpeur Audio"
  description: "Découpeur audio gratuit en ligne, sans téléchargement ni inscription."
  play: "Lecture"
  pause: "Pause"
  playRegion: "Lire la Région"
  pauseRegion: "Pause Région"
  trim: "Découper"
...
ja:
  toolName: "音声トリマー"
  description: "オンライン無料音声トリマー、アップロードや登録不要。"
  play: "再生"
  pause: "一時停止"
  playRegion: "区間再生"
  pauseRegion: "区間停止"
  ...
  zoom: "ズーム"
ru:
  toolName: "アудио Триммер"
  description: "Бесплатный онлайн-триммер аудио, без загрузки и регистрации."
  play: "Воспроизвести"
  pause: "Пауза"
  playRegion: "Воспроизвести Область"
  pauseRegion: "Пауза Области"
  trim: "Обрезать"
  download: "Скачать"
  clear: "Очистить"
...
de:
  toolName: "Audio-Trimmer"
  description: "Kostenloser Online-Audio-Trimmer, ohne Upload und Registrierung."
  play: "Abspielen"
  pause: "Pause"
  playRegion: "Region Abspielen"
  pauseRegion: "Region Pause"
  trim: "Zuschneiden"
